...
export const projects: Project[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Configuration Assistant — AI-powered configurator that performs actual configuration changes in the Fenergo SaaS platform from any input (text, screenshots, URLs)',
      'Policy Extractor — full auditable Excel extracts from any FenX tenant in one click (adopted org-wide)',
      ...
      'MDES Config Aligner — reconciliation between client master data dictionaries and live config',
    ],
  },
];
